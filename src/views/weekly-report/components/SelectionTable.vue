        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead class="min-w-28 text-right">
                收盤價
              </TableHead>
              <TableHead class="min-w-28 text-right">
                20MA
          ...
          <TableBody>
            ...
            >
              ...
              <TableCell>
                <Badge :variant="typeVariant(s.type)">
                  {{ s.type }}
                </Badge>
              </TableCell>
              ...
              <TableCell class="max-w-32 text-xs text-muted-foreground">
                {{ s.fundamental }}
              </TableCell>
              <TableCell class="max-w-32 text-xs text-muted-foreground">
                {{ s.technical }}
      ...
      <CardContent class="flex flex-col gap-3 p-5">
        ...
        <div class="flex items-end justify-between">
          ...
          <div class="w-20 text-center">
            ...
            <p class="font-mono text-base font-bold tabular-nums text-brand">
              {{ s.targetPrice > 0? s.targetPrice.toLocaleString(): '- -' }}
            </p>
          </div>
        </div>
      </CardContent>
