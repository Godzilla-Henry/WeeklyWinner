  ...
  >
    <CardHeader class="p-5">
      <div class="flex items-center gap-3">
        <!-- Icon -->
        <div
          class="relative flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl"
        ...
        <!-- 箭頭（固定右側） -->
        <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-secondary transition-all duration-300 group-hover:bg-brand/10">
          <ChevronRight
            :size="14"
